...
<em style="font-size: 0.9em;"><strong class="error">Warning:</strong> To perform this calculation, it requires measurements of high voltage while the amp is turned on. Working with voltages can be very dangerous or even fatal, so do not do so unless you are knowledgeable and skilled enough to work on tube amps. Please see these reference links for more information on this procedure: <a href="https://www.youtube.com/watch?v=yetFA4X4wo0" target="_blank">Biasing Tube Amps</a>, <a href="https://www.youtube.com/watch?v=w9B0Rhr_Y-E" target="_blank">Biasing an Amp (Part 1)</a>, <a href="https://www.youtube.com/watch?v=pjKYiSr497w" target="_blank">Biasing an Amp (Part 2)</a>, <a href="https://robrobinette.com/How_to_Bias_a_Tube_Amp.htm" target="_blank">How to Bias an Amp</a>.</em><br /><br />
INSTR;
